...
const fetchWeatherInformation = () => {
  return {
    type: AppConstants.FETCHING_WEATHER_INFORMATION
  };
};

const fetchedWeatherInformation = weatherInformation => {
  return {
    type: AppConstants.FETCHED_WEATHER_INFORMATION,
    weatherInformation
  };
};

const removeWeatherInformation = () => {
  return {
    type: AppConstants.ERASE_WEATHER_INFORMATION
  }
}
...
export const eraseWeatherInformation = () => dispatch => {
  dispatch(removeWeatherInformation());
};